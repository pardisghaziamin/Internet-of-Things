...
const char* ssid = "WifiName"; //AccessPoint Name
...
void loop() {
 ...
 s += "<div class=\"col-md-2\"><input class=\"btn btn-block btn-lg btn-warning\"style=\"font-size:28px;border-radius:100%;height:100px;width:100px;\" type=\"button\" value=\"blink\" onclick=\"blink1()\"></div>";
 ...
 s += "<div class=\"col-md-2\"><input class=\"btn btn-block btn-lg btn-warning\"style=\"font-size:28px;border-radius:100%;height:100px;width:100px;\" type=\"button\" value=\"blink\" onclick=\"blink2()\"></div>";
